                            ...
                            <form action="{{ route('companies.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="type" class="form-control @error('type') is-invalid @enderror" id="type" placeholder="Enter Company Type" value="{{ old('type') }}">
                                        @error('name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="website" class="form-control" id="website" placeholder="Enter Company Website" value="{{ old('website') }}">
                                    </div>
                                    <div class="form-group">
